            ...
            <div id="body" style="clear:left">
                <dl class="content">
                    ...
                    <dd>
                        ...
                        <span>虚拟商品101001 实物商品109001 账户充值108001
                        </span>
                    </dd>
                    <dt>商户唯一订单号：</dt>
                    <dd>
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="info_order" value=用户23423423购买羽毛球3桶 />
                        <span></span>
                    </dd>
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="acct_name" value=张三 />
                        <span></span>
                    </dd>
                      <dt>身份证号：</dt>
                    <dd>
                    ...
                    <dd>
                        ...
                        <span>php5.6 以上 风控参数要加斜杠转义符{\"frms_ware_category\":\"2009\"...这种格式</span>
                    </dd>
                    <dt>订单有效时间：</dt>
                    <dd>
                        <span class="null-star">*</span>
