    ...
    <section class="new-form">
        ...
        <section class="huankuan mui-clearfix">
            ...
            <div class="huankuan-right">
                ...
                <i><span>&nbsp;&nbsp;(利息10元+管理费：￥<span id="rixi">0.00</span>元 <br />实际放款：￥<i id="fuwufei">0.00</i>元)</span>
            </div>
        </section>
        <!--条款-->
		...
		<div class="gundong">
			...
			<?php if(is_array($redaydata)): foreach($redaydata as $key=>$vo): ?><span><?php echo date("Y-m-d"); ?></span> : <span class="gundong_phone"><?php echo ($vo["phone"]); ?></span> 成功借款 <span class="gundong_money"></span>! <br><?php endforeach; endif; ?>
			</marquee>
		</div>
        <section class="other">
...
$(function(){
	for(var i=0;i<months.length;i++){
		var tmp;
		tmp = months[i];
		var html = '<button id="'+i+'m" class="timeBtn "><span id="timeSpanVal_'+i+'">'+tmp+'</span>周</button>';
